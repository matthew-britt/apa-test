document.addEventListener("DOMContentLoaded", () => {
  ...
  function fetchLead(leadName) {
    fetch(`https://api.airtable.com/v0/appI40FwYNAUQHKq3/Contacts/${leadName}`, {
      headers: {
  ...
  function fetchReportLead(reportLeadName) {
    fetch(
      `https://api.airtable.com/v0/appI40FwYNAUQHKq3/Contacts/${reportLeadName}`,
      {
        headers: {
          Authorization: "Bearer keyemv7utChwq4g5e",
        },
  ...
  function fetchMember(memberName) {
      fetch(
        `https://api.airtable.com/v0/appI40FwYNAUQHKq3/Contacts/${memberName}`,
        {
          headers: {
            Authorization: "Bearer keyemv7utChwq4g5e",
          },
